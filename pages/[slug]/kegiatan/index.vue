        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr v-for="(item, index) in paginatedData" :key="`${item.kegiatan_id}-${item.satker_id}-${item.tahun_anggaran_id}`" class="hover:bg-gray-50 transition-colors duration-150">
                ...
                <td class="px-6 py-4 text-sm text-gray-900">{{ item.nama_kegiatan }}</td>
