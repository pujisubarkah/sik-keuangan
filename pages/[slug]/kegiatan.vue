              ...
              <tr v-for="(item, index) in filteredData" :key="item.id" class="hover:bg-blue-50 transition-all duration-150">
                ...
                <td class="text-center">
                  <div class="flex gap-1 justify-center">
                    <NuxtLink :to="`/kegiatan/view?id=${item.id}`" class="btn btn-xs btn-circle btn-info tooltip" data-tip="View">
                      <Icon icon="tabler:eye" class="w-5 h-5" />
                    </NuxtLink>
                    <NuxtLink :to="`/kegiatan/update?id=${item.id}`" class="btn btn-xs btn-circle btn-warning tooltip" data-tip="Update">
