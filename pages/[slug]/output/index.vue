              ...
              >
                ...
                <td class="px-3 py-2 text-right align-middle">
                  <div class="flex justify-end space-x-2">
                    <NuxtLink :to="`/${$route.params.slug}/output/view/${item.output_id}`" class="bg-blue-50 p-2 rounded hover:bg-blue-100 text-blue-600 transition tooltip" title="Lihat Detail">
                      <IconEye class="h-4 w-4 text-blue-600" />
                    </NuxtLink>
                    <NuxtLink :to="`/${$route.params.slug}/output/update/${item.output_id}`" class="bg-yellow-50 p-2 rounded hover:bg-yellow-100 text-yellow-600 transition tooltip" title="Edit">
                      <IconPencil class="h-4 w-4 text-yellow-600" />
                    </NuxtLink>
                    <button @click="openDeleteModal(item.output_id)" class="bg-red-50 p-2 rounded hover:bg-red-100 text-red-600 transition tooltip" title="Hapus">
