export const getMenuItems = (role = 'user', slug = 'default', role_id = null) => {
  ...
  const role8Menu = [
    { title: 'Beranda', icon: 'tabler:home', to: `/${effectiveSlug}`, group: 'navigation', children: [] },
    ...
    { title: 'Rincian Output', icon: 'tabler:folder', to: `/${effectiveSlug}/suboutput`, group: 'navigation', children: [] },
