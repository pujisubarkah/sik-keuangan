      ...
      <table class="min-w-full divide-y divide-gray-200 text-sm" style="table-layout: auto;">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="(program, index) in programs" :key="program.id" class="hover:bg-yellow-50">
            ...
            <td class="px-3 py-2 text-center align-middle">
              <span class="inline-block bg-green-100 text-green-700 rounded px-2 py-1 font-semibold">{{ program.outputs }}</span>
            </td>
            <td class="px-3 py-2 text-center align-middle">
              <span class="inline-block bg-yellow-100 text-yellow-700 rounded px-2 py-1 font-semibold">{{ program.subOutputs }}</span>
            </td>
