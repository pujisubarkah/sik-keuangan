	...
	<div class="mb-6">
		<div class="flex items-center justify-between mb-4">
			...
			<div class="flex gap-2">
				<a class="btn btn-sm flex items-center gap-1.5 text-white bg-[#00B925] hover:opacity-90 transition-colors" style="border-radius:0.5rem;padding:0.5rem 1rem;" href="/index.php?r=admin/index&export=1&exportObject=kegiatan">
			...
			<table class="min-w-full divide-y divide-gray-200 text-sm" style="table-layout: auto;">
				...
				<tbody class="divide-y divide-gray-100">
					...
					<tr class="bg-blue-50 font-bold">
						<th colspan="5" class="px-3 py-2 text-right align-middle">TOTAL</th>
...
const kegiatanData = computed(() =>
	props.activities.map(item => ({
		...
		output: item.jumlah_output,
		suboutput: item.jumlah_suboutput,
		pagu: item.pagu,
