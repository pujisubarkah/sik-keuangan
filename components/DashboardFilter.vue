  ...
  >
    ...
    <div class="p-5 md:p-6">
      ...
      <div class="flex items-center justify-between mb-5 pb-4 border-b border-blue-100">
        <h2 class="text-lg font-bold text-blue-800 flex items-center gap-2.5">
          <div class="p-2 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors">
            <Icon icon="mdi:filter" class="w-5 h-5 text-blue-600 group-hover:scale-110 transition-transform" />
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div class="md:col-span-4">
            <label class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
              <Icon icon="mdi:domain" class="w-4 h-4 text-blue-500" />
              <span>Satker</span>
            ...
            <div class="relative">
              ...
              <div class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
                <Icon icon="mdi:building" class="w-5 h-5 text-gray-400" />
              </div>
          ...
          <div class="md:col-span-4">
            <label class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
              <Icon icon="mdi:sitemap" class="w-4 h-4 text-blue-500" />
              <span>Unit</span>
            ...
            <div class="relative">
              ...
              <div class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
                <Icon icon="mdi:account-group" class="w-5 h-5 text-gray-400" />
              </div>
              <div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                <Icon icon="mdi:chevron-down" class="w-4 h-4 text-gray-400" />
              </div>
          ...
          <div class="md:col-span-2 flex items-end">
            ...
            >
              <Icon icon="mdi:magnify" class="w-5 h-5 group-hover:scale-110 transition-transform" />
              <span>Tampilkan</span>
            </button>
          </div>
        </div>
      ...
      <div class="flex flex-wrap gap-2 mt-6 pt-4 border-t border-blue-100">
        ...
        >
          <Icon icon="mdi:calendar-month" class="w-4 h-4 mr-1.5 group-hover:animate-bounce" />
        ...
        <a 
          ...
          class="btn btn-outline btn-sm btn-soft-success rounded-xl px-4 group"
        >
          <Icon icon="mdi:calendar-check" class="w-4 h-4 mr-1.5 group-hover:animate-pulse" />
        ...
        <button 
          ...
          title="Export data"
        >
          <Icon icon="mdi:download" class="w-4 h-4 mr-1.5" />
